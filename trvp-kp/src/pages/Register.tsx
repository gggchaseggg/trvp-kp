import { Button, Card, FormControl, FormLabel, FormHelperText, Input, Typography } from "@mui/joy";
...
const Register = () => {
    ...
    const handleClick = () => {
        ...
        // Мокаем успешную регистрацию: создаём нового пользователя и сразу логиним
